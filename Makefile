# This Makefile is for the RT::Extension::SelectBoxForwardFrom extension to perl.
#
...
#     ABSTRACT => q[RT-Extension-SelectBoxForwardFrom Extension]
#     AUTHOR => [q[Best Practical Solutions, LLC <modules@bestpractical.com>]]
#     BUILD_REQUIRES => { ExtUtils::MakeMaker=>q[6.59] }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[RT-Extension-SelectBoxForwardFrom]
#     INSTALLARCHLIB => q[/opt/rt4/local/plugins/RT-Extension-SelectBoxForwardFrom/lib]
#     INSTALLSITEARCH => q[/opt/rt4/local/man]
#     INSTALLSITELIB => q[/opt/rt4/local/plugins/RT-Extension-SelectBoxForwardFrom/lib]
#     INSTALLSITEMAN1DIR => q[/opt/rt4/local/man/man1]
#     INSTALLSITEMAN3DIR => q[/opt/rt4/local/man/man3]
#     INSTALLVENDORARCH => q[/usr/share/man]
#     INSTALLVENDORLIB => q[/opt/rt4/local/plugins/RT-Extension-SelectBoxForwardFrom/lib]
#     INSTALLVENDORMAN1DIR => q[/usr/share/man/man1]
#     INSTALLVENDORMAN3DIR => q[/usr/share/man/man3]
#     LICENSE => q[gplv2]
#     MIN_PERL_VERSION => q[5.008003]
#     NAME => q[RT::Extension::SelectBoxForwardFrom]
#     NO_META => q[1]
#     PREREQ_PM => { ExtUtils::MakeMaker=>q[6.59] }
#     SIGN => q[1]
#     TEST_REQUIRES => {  }
#     VERSION => q[0.01]
#     VERSION_FROM => q[lib/RT/Extension/SelectBoxForwardFrom.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = RT::Extension::SelectBoxForwardFrom
NAME_SYM = RT_Extension_SelectBoxForwardFrom
VERSION = 0.01
...
INSTALLSITELIB = /opt/rt4/local/plugins/RT-Extension-SelectBoxForwardFrom/lib
DESTINSTALLSITELIB = $(DESTDIR)$(INSTALLSITELIB)
INSTALLVENDORLIB = /opt/rt4/local/plugins/RT-Extension-SelectBoxForwardFrom/lib
DESTINSTALLVENDORLIB = $(DESTDIR)$(INSTALLVENDORLIB)
INSTALLARCHLIB = /opt/rt4/local/plugins/RT-Extension-SelectBoxForwardFrom/lib
...
MAKE = make
FULLEXT = RT/Extension/SelectBoxForwardFrom
BASEEXT = SelectBoxForwardFrom
PARENT_NAME = RT::Extension
DLBASE = $(BASEEXT)
VERSION_FROM = lib/RT/Extension/SelectBoxForwardFrom.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
DISTNAME = RT-Extension-SelectBoxForwardFrom
DISTVNAME = RT-Extension-SelectBoxForwardFrom-0.01
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>RT-Extension-SelectBoxForwardFrom Extension</ABSTRACT>' >> $(DISTNAME).ppd
